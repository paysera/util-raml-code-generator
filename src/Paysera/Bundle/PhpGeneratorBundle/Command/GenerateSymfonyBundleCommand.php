...
{
    const CODE_TYPE = 'symfony_bundle';
    ...
    protected function configure()
    {
        ...
        $this
            ->setName('php-generator:symfony-bundle')
            ->setDescription('Generates Symfony Bundle from given RAML definition')
            ->addArgument('raml_file', InputArgument::REQUIRED, 'Full path to RAML file')
            ->addArgument('output_dir', InputArgument::REQUIRED, 'Where to put generated Bundle')
            ->addArgument('namespace', InputArgument::REQUIRED, 'Namespace of generated Bundle, i.e.: Acme\\\\Bundle\\\\AcmeBundle')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln(sprintf(
            '<info>Bundle successfully generated to <comment>%s</comment> directory</info>',
            $outputDir
        ));
        $output->writeln('');
    }
